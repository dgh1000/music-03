...
public class GraphicsUtils {
    ...
    public static void drawNote(
        ...
        g.setColor(c);
        double x1 = Math.scale_3_2(scaleMin, n.tOn, scaleMax, 0, width);
        double x2 = Math.scale_3_2(scaleMin, n.tOff, scaleMax, 0, width);
        double y1 = Math.scale_3_2(20, n.pitch, 90, height, 0);
